...
""", unsafe_allow_html=True)
  ...
  <div><div class="tb-sub">Interaction Conversion Index · Intelligence</div>
    ...
    def _load_view(name):
        ...
        path = os.path.join(base, "views", f"{name}.py")
    ...
    if cur == "approach":
        _load_view("approach")(eng)
    elif cur == "overview":
        _load_view("overview")(eng, hcps)
    elif cur.startswith("cluster_"):
        _load_view("cluster_detail")(int(cur.split("_")[1]), hcps, eng)
    elif cur == "integrated":
        _load_view("integrated")(eng, hcps)
    elif cur == "crosstabs":
        _load_view("crosstabs")(eng)
    elif cur == "qualitative":
        _load_view("qualitative")(eng)
    elif cur == "envelope":
        _load_view("envelope")(eng, hcps)
    else:
        _load_view("overview")(eng, hcps)
